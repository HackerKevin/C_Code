...
struct __RBTreeIterator
{
	...
	// typedef typename RBTree<K, K, SetKeyOfT>::const_iterator iterator;       拷贝构造
	// typedef typename RBTree<K, K, SetKeyOfT>::const_iterator const_iterator; 支持普通迭代器转换成构造const迭代器的构造函数
